...
namespace C968___Inventory_Application
{
    public partial class AddProductScreen : Form
    {
        ...
        public static BindingList<Part> partsToAssociate = new BindingList<Part>();
        ...
        // Constructors ------------------------------------------------------------------------------------------------------------------------
        public AddProductScreen(MainScreen mainScreen)
        {
            this.mainScreen = mainScreen;
            InitializeComponent();
            CandidatePartsDataGrid.DataSource = Inventory.AllParts;
            AssociatedPartsDataGrid.DataSource = partsToAssociate;
        }
        ...
        private void AssociatedPartsDeleteButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("An associated part was not selected. Please click on row containing an associated part.", "No Associated Part Selected");
            }
            else
            {
                ...
                {
                    partsToAssociate.Remove(partsToAssociate[currentAssociatedPartIndex]);
                }
            }
        }
